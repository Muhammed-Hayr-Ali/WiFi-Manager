...
void WiFiManager::setupConfigPortal() {
  ...
  server->on(String(F("/h")), std::bind(&WiFiManager::handleHelp, this));
...
void WiFiManager::handleWifiSave() {
  ...
  for (int i = 0; i < _paramsCount; i++) {
   ...
   // String d = server->arg(_params[1]->getID()).c_str();
  ...
  String dn = server->arg(_params[1]->getID()).c_str();
...
void WiFiManager::handleInfo() {
  ...
  page += F("<td>Device ID</td><td>");
  page += ESP.getChipId();
  page += F(" </td>  </tr>    <tr>   <td>Device Name</td><td>");
  page += _apName;

  
  page += F("</td></tr><tr><td>CPU Frequency</td><td>");
  page += ESP.getCpuFreqMHz();
  page += F(" Mhz</td> </tr>  <tr>   <td>Flash chip size</td><td>");
  page += ESP.getFlashChipSize();
  page += F(" bytes</td> </tr>  <tr>   <td>Free Heap size</td><td>");
  page += ESP.getFreeHeap();
  page += F(" bytes</td> </tr>  <tr>   <td>DK Version</td><td>");
  page += ESP.getSdkVersion();
  page += F("</dd>");

  page += F("    </td></tr>  <tr><td>Access Point IP</td><td>");
  page += WiFi.softAPIP().toString();



  page += F("    </td> </tr>  <tr>   <td>MAC Address</td><td>");

...
//CSS Template Here
//https://www.w3schools.com/code/tryit.asp?filename=G2CPGSBT1O4T
...
const char HTTP_END[] PROGMEM             = "</div> <footer class=\"footer\">&copy; P.S.Technology, 2019. All Rights Reserved</footer> </body> </html>";
